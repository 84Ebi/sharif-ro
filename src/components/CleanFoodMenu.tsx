      ...
      >
        ...
        <div className="bg-white bg-opacity-95 p-4 flex items-center justify-between border-b">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-2xl font-bold text-gray-800">{t('cleanfood.title')}</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-2">
          <div className="bg-white bg-opacity-90 rounded-xl p-4 text-center space-y-4">
            ...
            <h3 className="text-xl font-bold text-gray-800">{t('cleanfood.order_online_title')}</h3>
            <p className="text-gray-700 text-right leading-relaxed">
              {t('cleanfood.order_online_text')}
            </p>
